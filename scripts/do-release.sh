...
echo "   Watch the release workflow: https://github.com/pdomain/pdomain-ocr-simple-gui/actions"
echo "   Release page (once workflow finishes): https://github.com/pdomain/pdomain-ocr-simple-gui/releases/tag/$VERSION"
