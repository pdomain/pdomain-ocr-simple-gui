...
- **Unit type:** screen
- **Address:** `/jobs/:id`
- **Implementation:** `frontend/src/pages/ResultsPage.tsx`
- **Backend / collaborators touched:** `routes/jobs.py` (status / rerun /
  delete), `routes/downloads.py`
...
Records added during capture (M4).
